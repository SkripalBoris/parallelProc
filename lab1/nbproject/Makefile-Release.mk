...
${OBJECTDIR}/src/GlobalMap.o: src/GlobalMap.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GlobalMap.o src/GlobalMap.cpp

${OBJECTDIR}/src/TextManager.o: src/TextManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TextManager.o src/TextManager.cpp

${OBJECTDIR}/src/WordsCounter.o: src/WordsCounter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WordsCounter.o src/WordsCounter.cpp
...
${TESTDIR}/tests/TestManagerTestClass.o: tests/TestManagerTestClass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestManagerTestClass.o tests/TestManagerTestClass.cpp


${TESTDIR}/tests/TestManagerTestRunner.o: tests/TestManagerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestManagerTestRunner.o tests/TestManagerTestRunner.cpp


${TESTDIR}/tests/newWordsCounterTestClass.o: tests/newWordsCounterTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newWordsCounterTestClass.o tests/newWordsCounterTestClass.cpp


${TESTDIR}/tests/newWordsCounterTestRunner.o: tests/newWordsCounterTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newWordsCounterTestRunner.o tests/newWordsCounterTestRunner.cpp
...
${OBJECTDIR}/src/GlobalMap_nomain.o: ${OBJECTDIR}/src/GlobalMap.o src/GlobalMap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GlobalMap_nomain.o src/GlobalMap.cpp;\
	else  \
...
${OBJECTDIR}/src/TextManager_nomain.o: ${OBJECTDIR}/src/TextManager.o src/TextManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TextManager_nomain.o src/TextManager.cpp;\
	else  \
...
${OBJECTDIR}/src/WordsCounter_nomain.o: ${OBJECTDIR}/src/WordsCounter.o src/WordsCounter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/WordsCounter_nomain.o src/WordsCounter.cpp;\
	else  \
