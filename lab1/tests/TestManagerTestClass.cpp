...
void TestManagerTestClass::testTextManager() {
    ...
    CPPUNIT_ASSERT_EQUAL(wc->getCounterMap()->at("Hello"),2);
    CPPUNIT_ASSERT_EQUAL(wc->getCounterMap()->at("world"),1);
    delete(wc);
}
...
void TestManagerTestClass::testTextManager2() {
    ...
    CPPUNIT_ASSERT_EQUAL(textManager->getCounterMap()->at("лесу"),3);
    CPPUNIT_ASSERT_EQUAL(textManager->getCounterMap()->at("Мороз"),1);
    delete(textManager);
}